...
.btnedit::before {
    ...
    right: 0;
    bottom: 0;
    background: linear-gradient(60.72deg, rgb(14, 0, 172) -11%, rgb(255, 52, 249) 86.67%);
    opacity: 0; /* Initially invisible */
    transition: opacity 1s ease; /* Smooth transition for opacity */
    filter: blur(10px); /* Blur effect to create shadow appearance */
    z-index: -1; /* Place it behind the button */
    border-radius: inherit; /* Ensure rounded corners match the button if it has any */
}

/* Apply the gradient shadow on hover */
.btnedit:hover::before {
    transition: 1s;
    opacity: .6; /* Make the pseudo-element visible on hover */
}

/* Gradient text on hover */
.btnedit:hover {
    transition: 1s  3s;
    background-image: linear-gradient(60.72deg, rgb(14, 0, 172) -11%, rgb(255, 52, 249) 86.67%);
...
<body class="pbody">
    ...
    <div id="navbar" class="navbar navbar-hidden">
        ...
        <a href="edit.php" class="btnedit">&nbsp;&nbsp;<img src="./images/pencil.png" alt="pencil.png" class="png6" data-tilt/>&nbsp;&nbsp;Edit Profile&nbsp;&nbsp;</a>
</div>
        <a href="login.php" class="btnout" onclick="return confirm('Are you sure you want to log out?');" style="background-color: #818181;">&nbsp;&nbsp;Log out&nbsp;&nbsp;</a>
</div>
    </div>
    ...
    <form class="pform2" method="post" action="server.php">
        ...
        <div class="pelements-container">
            ...
            <div class="pelements">
                ...
                <br>
                <div class="pelements">
                    <a href="edit.php" class="btnedit"  style="border: 1px solid #1d1d1f">&nbsp;&nbsp;<img src="./images/pencil.png" alt="pencil.png" class="png6" data-tilt/>&nbsp;&nbsp;Edit Profile&nbsp;&nbsp;</a>
                </div>
            </div>
        </div>
    </form>
  ...
  <video id="myVideo" autoplay loop muted>
    ...
    <div class="left">
            <img src="./images/jay.png" alt="draw.png" data-tilt/>
        </div>
        <div class="right">
        </div>
    </div>
    ...
    <div class="container-b fade-in4">
        ...
        <div class="right">
            <img src="./images/magickeyboard.jpg" alt="magickeyboard.jpg" data-tilt/>
        </div>
    </div>
    <!---->
