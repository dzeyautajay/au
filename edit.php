...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($_FILES['profile_picture']['size'] > 0) {
        ...
        if ($_FILES['profile_picture']['size'] > $maxFileSize) {
            ...
            $_SESSION['error'] = "Error: The uploaded file exceeds the maximum file size limit.";
        } else {
            ...
            if (mysqli_query($db, $query)) {
                ...
                $profile_picture_data = mysqli_real_escape_string($db, file_get_contents($profile_picture_tmp));

                // Update the profile picture in the database
                $query = "UPDATE users SET profile_picture='$profile_picture_data' WHERE username='$username'";
                if (!mysqli_query($db, $query)) {
                    $_SESSION['error'] = "Error updating profile picture: " . mysqli_error($db);
                } else {
            ...
            <div class="input_picture">
                <div class="picturebox">
                    ...
                    if (!empty($user['profile_picture'])) {
                        ...
                        echo '<img id="profile-picture-preview" src="./images/default.jpg" alt="Default Profile Picture" data-tilt/>';
                    }
                    ?>
                </div>
                <div class="upload">
                    <label for="profile-picture-input" class="custom-file-upload"><img src="./images/pencil.png" alt="pencil.png" class="png5" data-tilt/>&nbsp;Upload</label>
...
<div class="input-group">
    ...
    <input type="text" id="email" name="email" value="<?php echo $user['email']; ?>"required>
            ...
            <div class="input-group">
                <button type="submit" class="btn" name="update_profile"><img src="./images/check.png" alt="check.png" class="png4" data-tilt/>&nbsp;&nbsp;Save Changes</button>
            </div>
            <br>
            <div class="input-group" >
            <a href="password.php" class="btn1"><img src="./images/admin.png" alt="admin.png" class="png5" data-tilt/>&nbsp;&nbsp;Account ownership and security</a>
    </div>
