...
<body>
    ...
    <div class="header">
        ...
        <?php if (isset($_SESSION['error'])) : ?>
            ...
            <div class="input-group">
                ...
                <button type="submit" class="btn" name="change_password_username" id="changePasswordButton" disabled><img src="./images/padlock.png" alt="padlock.png" class="png4" data-tilt/>&nbsp;&nbsp;&nbsp;Change Password and Username</button>
            </div>
            <br>
    ...
    &nbsp;
    <button type="submit" class="btn1 btndelete" name="delete_account" id="deleteAccountButton" onclick="return confirm('Are you sure you want to delete your account? This action cannot be undone.');" style="text-decoration: none; color: black;"><img src="./images/bin.png" alt="bin.png" class="png5" data-tilt/>&nbsp;&nbsp;&nbsp;Delete Account</button>
</div>
                <hr>
                <br>
